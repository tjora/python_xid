...
TestXids = [
    ...
    {
        'xid': Xid(bytes([0x4d, 0x88, 0xe1, 0x5b, 0x60, 0xf4, 0x86, 0xe4, 0x28, 0x41, 0x2d, 0xc9])),
        'ts': 1300816219,
        'machine': bytes([0x60, 0xf4, 0x86]),
        'pid': 0xe428,
        'counter': 4271561
    },
    {
        'xid': Xid(bytes([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])),
        'ts': 0,
        'machine': bytes([0x00, 0x00, 0x00]),
        'pid': 0x0000,
        'counter': 0
    },
    {
        'xid': Xid(bytes([0x00, 0x00, 0x00, 0x00, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0x00, 0x00, 0x01])),
        'ts': 0,
        'machine': bytes([0xaa, 0xbb, 0xcc]),
        'pid': 0xddee,
        'counter': 1
    }
]
...
class TestXid(unittest.TestCase):
    ...
    def test_copy_string_from_golang(self):
        ...
        self.assertEqual(x.value, bytes([0x4d, 0x88, 0xe1, 0x5b, 0x60, 0xf4,
                                   0x86, 0xe4, 0x28, 0x41, 0x2d, 0xc9]))
